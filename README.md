...
- [ ] 각 자동차에 이름을 부여할 수 있다.
  ...
  - [ ] [예외상황] 자동차 이름이 0자 이하 또는 6자 이상인 경우
  - [ ] [예외상황] 자동차 이름이 쉼표(,)를 기준으로 입력되지 않은 경우
  - [ ] [예외상황] 쉼표가 연속으로 여러번 입력되었을 경우
  - [ ] [예외상황] 이름의 중간에 공백이 입력된 경우
  - [ ] [예외상황] 문자와 숫자가 입력되지 않은 경우
  - [ ] [예외상황] "" 또는 " "가 입력된 경우
  - [ ] [예외상황] 이름이 중복되어 입력된 경우
...
- 쉼표가 연속으로 여러번 입력되었을 경우 (ex - pobi,,woni,jun)
...
- 시도할 횟수가 0인 경우
  - 판단: 경주가 진행되지 않으니, 잘못된 값으로 간주하고 예외를 발생시킨다.
- 시도할 횟수의 최대 크기
  - 판단: 최대 100번까지 시도할 수 있다.
