...
### 자동차의 전진/정지 처리
- [x] 주어진 횟수 동안 n대의 자동차는 전진 또는 정지할 수 있다.
    - [x] 무작위 값이 4 이상 9 이하일 경우 전진한다.
    - [x] 무작위 값이 0 이상 3 이하일 경우 정지한다.
...
## 5. 구현 시간
- 기능 목록 작성: 1시간 20분
- TDD 종료: 기능 목록 작성 + 5시간 (총 6시간 20분)
- MVP 완성: TDD 종료 + 1시간 10분 (총 7시간 30분)
- 리팩토링: MVP 완성 + 2시간 (총 9시간 30분)
- 총 구현 시간: 리팩토링 + 테스트 추가(1시간 30분) = 총 10시간 30분
